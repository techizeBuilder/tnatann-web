    ...
    <>
      ...
      >
        <div className="container relative">
          ...
          <CustomImage
            src={Img1}
            className="hidden xl:block absolute xl:-top-[38%] xl:ltr:left-[3%] xl:rtl:right-[3%] xl:w-[110px] rounded-full"
            height={135}
            width={90}
          ...
          <CustomImage
            src={Img2}
            className="hidden xl:block absolute xl:top-[38%] xl:ltr:left-[9%] xl:rtl:right-[9%] xl:w-[110px] rounded-full"
            height={135}
            width={90}
          ...
          <CustomImage
            src={Img3}
            className="hidden xl:block absolute xl:top-[120%] xl:ltr:left-[3%] xl:rtl:right-[3%] xl:w-[110px] rounded-full"
            height={90}
            width={90}
          ...
          <CustomImage
            src={Img4}
            className="hidden xl:block absolute xl:-top-[38%] xl:ltr:right-[3%] xl:rtl:left-[3%] xl:w-[110px] rounded-full"
            height={135}
            width={90}
          ...
          <CustomImage
            src={Img5}
            className="hidden xl:block absolute xl:top-[38%] xl:ltr:right-[9%] xl:rtl:left-[9%] xl:w-[110px] rounded-full"
            height={90}
            width={90}
          ...
          <CustomImage
            src={Img6}
            className="hidden xl:block absolute xl:top-[109%] xl:ltr:right-[3%] xl:rtl:left-[3%] xl:w-[110px] rounded-full"
            height={0}
            width={0}
