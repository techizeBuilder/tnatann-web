              ...
              >
                {index !== workProcessSteps.length - 1 && (
                  <CustomImage
                    ...
                    width={128}
                    height={22}
                    className="absolute hidden w-32 top-[5%] lg:block lg:-right-[34%] xl:-right-[30%] 2xl:-right-[25%] rtl:right-auto lg:rtl:-left-[34%] xl:rtl:-left-[30%] 2xl:rtl:-left-[25%] rtl:scale-x-[-1]"
                  />
                )}
