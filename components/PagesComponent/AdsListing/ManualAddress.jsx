        ...
        <div className="flex flex-col gap-4 py-4">
            ...
            >
              <PopoverTrigger asChild>
                <Button
                  ...
                  className={`w-full justify-between outline-hidden ${fieldErrors.country ? "border-red-500" : ""
                    }`}
                >
                  {CountryStore?.SelectedCountry?.translated_name ||
                    CountryStore?.SelectedCountry?.name ||
            ...
            >
              <PopoverTrigger asChild>
                <Button
                  ...
                  className={`w-full justify-between outline-hidden ${fieldErrors.state ? "border-red-500" : ""
                    }`}
            ...
            >
              <PopoverTrigger asChild>
                <Button
                  ...
                  className={`w-full justify-between outline-hidden ${fieldErrors.city ? "border-red-500" : ""
                    }`}
          ...
          {hasAreas || AreaStore?.AreaSearch ? (
              ...
              >
                <PopoverTrigger asChild>
                  <Button
                    ...
                    className={`w-full justify-between outline-hidden ${fieldErrors.address ? "border-red-500" : ""
                      }`}
            ...
            <div className="flex flex-col gap-1">
              <Textarea
                rows={5}
                className={`border p-2 outline-hidden rounded-md w-full ${fieldErrors.address ? "border-red-500" : ""
                  }`}
