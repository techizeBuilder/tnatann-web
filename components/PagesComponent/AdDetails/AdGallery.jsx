...
const AdGallery = ({ galleryImages, videoData }) => {
      ...
      <div className="relative">
        ...
        >
          ...
          </CarouselContent>
          {
            ...
            <>
              <div className="hidden lg:block absolute top-1/2 ltr:left-2 rtl:right-2 -translate-y-1/2">
                <button
              ...
              <div className="hidden lg:block absolute top-1/2 ltr:right-2 rtl:left-2 -translate-y-1/2">
                <button
