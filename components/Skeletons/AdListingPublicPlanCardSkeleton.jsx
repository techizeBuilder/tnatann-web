    ...
    <>
      ...
      <div className="flex gap-4 overflow-x-auto scrollbar-none">
        {Array.from({ length: 4 }).map((_, index) => (
          <div
            key={index}
            className="rounded-lg p-8 shadow-xs border bg-white basis-[90%] sm:basis-[75%] md:basis-[55%] lg:basis-[45%] xl:basis-[35%] 2xl:basis-[30%] shrink-0 first:pl-4"
          >
            {/* Card Header */}
            ...
            <div className="space-y-2 mb-2 h-62.5 max-h-62.5 overflow-y-auto p-4 md:p-0 flex flex-col">
              {[...Array(5)].map((_, i) => (
