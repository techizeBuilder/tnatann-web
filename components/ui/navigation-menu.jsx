...
const NavigationMenuTrigger = React.forwardRef(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Trigger
    ref={ref}
    className={cn(navigationMenuTriggerStyle(), "group flex gap-1 rtl:flex-row-reverse", className)}
    {...props}>
    {children}{" "}
    <ChevronDown
...
const NavigationMenuViewport = React.forwardRef(({ className, ...props }, ref) => (
  <div className={cn("absolute left-0 rtl:left-auto rtl:right-0 top-full flex justify-center")}>
