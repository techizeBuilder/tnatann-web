...
import { getOtpServiceProvider, getReferralSettings } from "@/redux/reducer/settingSlice";
  ...
  return (
    <>
      <div className="flex flex-col gap-4 py-6 px-4 h-full">
        <CustomLink
          href="/profile"
          className={`flex items-center gap-1 py-2 px-4 ${pathname === `/${langCode}/profile` ? "profileActiveTab" : ""
            }`}
        >
          <FiUser size={24} />
          <span>{t("profile")}</span>
        ...
        <CustomLink
          href="/notifications"
          className={`flex items-center gap-1 py-2 px-4 ${pathname === `/${langCode}/notifications` ? "profileActiveTab" : ""
            }`}
        >
        ...
        <CustomLink
          href="/chat"
          className={`flex items-center gap-1 py-2 px-4 ${pathname === `/${langCode}/chat` ? "profileActiveTab" : ""
            }`}
        >
          <BiChat size={24} />
          <span>{t("chat")}</span>
        ...
        <CustomLink
          ...
          className={`flex items-center gap-1 py-2 px-4 ${pathname === `/${langCode}/user-subscription` ? "profileActiveTab" : ""
            }`}
        >
          <BiDollarCircle size={24} />
          <span>{t("subscription")}</span>
        </CustomLink>
        {refer_earn_enabled && <CustomLink
          href="/refer-and-earn"
          className={`flex items-center gap-1 py-2 px-4 ${pathname === `/${langCode}/refer-and-earn` ? "profileActiveTab" : ""
            }`}
        >
          <PiHandCoins size={24} />
        ...
        <CustomLink
          href="/my-ads"
          className={`flex items-center gap-1 py-2 px-4 ${pathname === `/${langCode}/my-ads` ? "profileActiveTab" : ""
            }`}
        >
          <LiaAdSolid size={24} />
          <span>{t("myAds")}</span>
        ...
        <CustomLink
          href="/favorites"
          className={`flex items-center gap-1 py-2 px-4 ${pathname === `/${langCode}/favorites` ? "profileActiveTab" : ""
            }`}
        >
          <LuHeart size={24} />
        ...
        <CustomLink
          href="/transactions"
          className={`flex items-center gap-1 py-2 px-4 ${pathname === `/${langCode}/transactions` ? "profileActiveTab" : ""
            }`}
        >
          <BiReceipt size={24} />
        ...
        <CustomLink
          href="/reviews"
          className={`flex items-center gap-1 py-2 px-4 ${pathname === `/${langCode}/reviews` ? "profileActiveTab" : ""
            }`}
        >
        ...
        <CustomLink
          ...
          className={`flex items-center gap-1 py-2 px-4 ${pathname === `/${langCode}/job-applications` ? "profileActiveTab" : ""
            }`}
        >
